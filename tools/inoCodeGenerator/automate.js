...
function automatePages(language) {
  ...
  pagesHeader = pagesHeader.replace('<<<MENUHTML>>>', minify.minifyFileByPath('../../router-esp32/pages/' + language + '/menu.html', credentials.ssid));
  pagesHeader = pagesHeader.replace('<<<REFEREEHTML>>>', minify.minifyFileByPath('../../router-esp32/pages/' + language + '/referee.html', credentials.ssid));
